...
onSubmit = (e) =>{
   ...
   this.props.registerUser(newUser, this.props.history);
    ...
    <div className="col-md-6 m-auto centered">
      <div className="">
        ...
        <div className="form-group col-md-12">
            ...
            <input
              ...
              error = {errors.name}
            />
                  {errors.name? <div style={{color:"red",textAlign:"left",fontSize:"10px"}}>{errors.name}</div> : null} 
          </div>
        ...
        <p className="mt-4">Have An Account? <Link to ="/login">Sign In</Link></p>
      </div>
    </div>
  </div>
            </div>
