    ...
    render() {
        ...
        return (
            <div className="card animated fadeInLeft">
                ...
                <p class="heading">Add your projects information</p>
                <form onSubmit={this.continue}>
                    ...
                    <div className="container text-center">
                        <button type="button" className="btn btn-info projectBtn" onClick={this.back}><i className="fas fa-angle-left mr-1"></i>Back</button>
                        <button type="submit" className="btn btn-info projectBtn">Next<i className="fas fa-angle-right ml-1"></i></button>
                    </div>
                    <br />
                </form>
            </div>
